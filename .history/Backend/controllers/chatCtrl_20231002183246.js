...
module.exports = {
    ...
    async getChatByUser(req, res) {
        try {
            ...
            res.status(501).json({error:"Erreur lors de l'affichage des conversations d'un user"})
        }
    }
}