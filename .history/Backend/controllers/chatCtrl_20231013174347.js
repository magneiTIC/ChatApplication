...
module.exports = {
  ...
  async getChatsByUser(req, res) {
    try {
      const uid = req.params.uid;  // Obtenez l'UID de l'utilisateur à partir de la requête
  
      // Recherchez l'utilisateur par UID pour obtenir l'ObjectId correspondant
      ...
      // Maintenant, cherchez les conversations où l'ObjectId de l'utilisateur correspond
