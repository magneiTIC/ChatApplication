...
export class ChatComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.chatsService.selectedChatId.subscribe((chatId) => {
      this.messages = this.messagesService.getMessagesByChat('' + chatId);
    });
  }
  ...
  messages: Observable<any> = this.chatsService.selectedChatId$.pipe(
    switchMap(chatId => this.messagesService.getMessagesByChat('' + chatId))
  );
