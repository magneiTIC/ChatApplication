...
import { SocketService } from 'src/app/services/sockets/';
@Component({
  selector: 'app-chat',
...
export class ChatComponent implements OnInit{
  ...
  sendMessage() {
    if (this.messageControl) {
      this.socketService.sendMessage(this.messageControl);
      this.messageControl = ''; // Efface le champ de message après l'envoi.
    }
  }
}
