      ...
      try {
        ...
        switch (error.code) {
          case 'auth/user-not-found':
            ...
            this.connexionError = 'L\'utilisateur n\'existe pas.';
            break;
          case 'auth/wrong-password':
            // Le mot de passe est incorrect.
            this.connexionError = 'Le mot de passe est incorrect.';
            break;
          default:
            // Autres erreurs Firebase.
            this.connexionError = 'Une erreur s\'est produite lors de la connexion.';
            break;
        }
        reject(error);
